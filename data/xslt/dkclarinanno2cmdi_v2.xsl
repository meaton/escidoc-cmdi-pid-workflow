                                ...
                                <xsl:choose>
                                    <xsl:when test="@xml:lang">
                                        ...
                                        <cmd:title lang="{$titleLang}" level="a">
                                            substring-before(substring-after(<xsl:value-of select="cmd:olac/cmd:title"/>,"Annotation:"),', ')
                                            <!--<xsl:value-of select="text()"/>-->
                                        </cmd:title>
                                    </xsl:when>
									<xsl:when test="@lang">
                        ...
                        <cmd:monogr>
                            <xsl:for-each select="cmd:olac/cmd:title">
                                <xsl:choose>
                                    <xsl:when test="@xml:lang">
                                        <xsl:variable name="titleLang" select="@xml:lang"/>
                                        <cmd:title lang="{$titleLang}">substring-before(substring-after(<xsl:value-of select="cmd:olac/cmd:title"/>,"Annotation:"),', ')</cmd:title>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <cmd:title>
                                            <!--<xsl:value-of select="cmd:olac/cmd:title"/>-->
                                            substring-before(substring-after(<xsl:value-of select="cmd:olac/cmd:title"/>,"Annotation:"),', ')
                                        </cmd:title>
                                    </xsl:otherwise>
                                </xsl:choose>
