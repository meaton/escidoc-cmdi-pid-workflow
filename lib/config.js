module.exports = { ns_obj: {'sru-zr':'http://www.loc.gov/zing/srw/',
		...
		xslt_filepath: './data/xslt/dkclarintext2cmdi_v6.xsl',
		...
		target_cmdi_appInfo_xpath: '/CMD/Components/teiHeader/encodingDesc', // end TEI anno custom mods
		update_comment: '08-09-2014, MS. TEI anno test.'	
};
